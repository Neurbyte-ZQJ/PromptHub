...
| 首页 | 登录 | 注册 |
|:---:|:---:|:---:|
| ![首页](screenshots/首页.png) | ![登录](screenshots/登录.png) | ![注册](screenshots/注册.png) |
...
| 标签筛选 | 分类目录 |
|:---:|:---:|
| ![标签筛选](screenshots/标签筛选.png) | ![分类目录功能](screenshots/分类目录功能.png) |

### 收藏功能

| 收藏功能 | 我的收藏 |
|:---:|:---:|
| ![收藏功能](screenshots/收藏功能.png) | ![我的收藏界面](screenshots/我的收藏界面.png) |
